	...
	//, m_pSingle(nullptr)
{
	...
	CTerrainMgr::Get_Instance()->Set_ToolView(this);
}
...
void CToolView::OnInitialUpdate()
{
	...
	CTerrainMgr::Get_Instance()->Initialize();
	CTerrainMgr::Get_Instance()->Get_Terrain()->Set_MainView(this);
}
...
#pragma endregion 복습
	...
	CTerrainMgr::Get_Instance()->Get_Terrain()->Render();
...
void CToolView::OnLButtonDown(UINT nFlags, CPoint point)
{
	...
	CTerrainMgr::Get_Instance()->Get_Terrain()->Tile_Change(D3DXVECTOR3(float(point.x + GetScrollPos(0)), float(point.y + GetScrollPos(1)), 0.f), 0);
	...
	Invalidate(FALSE);
	CTerrainMgr::Get_Instance()->Get_MiniView()->GoInvalidate();
}
